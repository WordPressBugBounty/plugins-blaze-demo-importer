...
= 1.0.12 - May 8th, 2024 =
    * Added - wordpress compatibility

= 1.0.11 - Jun 10th, 2024 =
    * Added - site reset for plugin demo pages added

= 1.0.10 - June 17th, 2024 =
    * Fixed - demo import issue fixed with plugin directory path fixes

= 1.0.9 - June 9th, 2024 =
    * Fixed - demo import issue fixed for news kit elementor addons starter sites

= 1.0.8 - June 6th, 2024 =
    * Fixed - demo import issue for new admin pages fixed

= 1.0.7 - May 29th, 2024 =
    * Fixed - demo import issue fixed for new admin pages

= 1.0.6 - May 24th, 2024 =
    * Added - demo import ready for new demo pages

= 1.0.5 - December 12th, 2023 =
    * Added - import file directory check condition added
